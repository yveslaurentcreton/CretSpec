...
Native release archives require no Rust or Node.js installation. Homebrew, WinGet and AUR metadata are generated by the release pipeline; catalog publication is pending. See the [installation guide](website/src/content/docs/start/install.md) for platforms, upgrades and installation options.
